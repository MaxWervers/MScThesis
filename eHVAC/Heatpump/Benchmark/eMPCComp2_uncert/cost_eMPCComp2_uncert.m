function bill = cost_eMPCComp2_uncert(Nh_add, start, month, num_days, meta_data)
    ...
    for pred_idx = 1:num_preds
        ...
        for t = 1:Steps-1
            ...
            f = [c_real_pred' * 10e-6 * (1/H_split); zeros(N_vec_ext(t)*n, 1); 10e8 * ones(2*N_vec_ext(t), 1); cp/sigt];
    ...
    save(['Heatpump\Benchmark\eMPCComp2_uncert\cost_eMPCComp2_uncert',num2str(Nh_add),'h_add_', month, '_FULL'], vars{:})
